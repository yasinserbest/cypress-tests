...
describe("Accordion.cy.jsx", () => {
  it("items accordion", () => {
    cy.mount(<ItemsAccordion items={items} />); //hangi comp test edeceksen buraya onu girersin. e2e'de visit yapıyodun, burda mount yapıyosun test ediceğin componenti.
